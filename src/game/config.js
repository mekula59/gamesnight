...
export const RANK_FAQ = [
  ...
  },
  {
    ...
    name: "Sharpshooter",
    color: "#00E5FF",
    desc: "Best K/G in the room with at least 5 lobbies played. Clean work, very little waste.",
  },
  {
    icon: "🎮",
    name: "Ride or Die",
  ...
  },
  {
    ...
    name: "Eternal",
    color: "#F48FB1",
    desc: "500 or more all-time wins. The file is no longer just history. It is part of the room's ceiling.",
  },
  {
    icon: "🔺",
    name: "Ascendant",
    color: "#B388FF",
    desc: "300 or more all-time wins. Past every normal marker and still climbing.",
  },
  {
    icon: "🗻",
    name: "Apex",
    color: "#00E5FF",
    desc: "200 or more all-time wins. The file sits above almost everything the room has seen.",
  },
  {
    icon: "⚔️",
    name: "Warlord",
    color: "#FF6B35",
    desc: "150 or more all-time wins. A long-term closer with a crown count the room has to respect.",
  },
  {
    icon: "🛡️",
    name: "Immortal",
    color: "#FFD700",
    desc: "100 or more all-time wins. Triple digits puts the file into permanent room memory.",
  },
  {
    icon: "🔮",
    name: "Mythic",
    color: "#C77DFF",
    desc: "50 or more all-time wins. Too proven to be treated like a normal contender.",
  },
  {
    icon: "💎",
    name: "Elite",
    color: "#00FF94",
    desc: "25 or more all-time wins. A real closer with room above the old ceiling.",
  },
  {
    icon: "⚡",
    name: "Legend",
...
export const BADGE_CATALOGUE = [
  ...
  { icon: "🎯", name: "Sharpshooter", desc: "Best K/G ratio with 5 or more lobbies", how: "Keep your K/G highest after at least 5 appearances" },
  ...
  { icon: "🌌", name: "Eternal", desc: "500 or more total wins", how: "Reach 500 wins all time" },
  { icon: "🔺", name: "Ascendant", desc: "300 or more total wins", how: "Reach 300 wins all time" },
  { icon: "🗻", name: "Apex", desc: "200 or more total wins", how: "Reach 200 wins all time" },
  { icon: "⚔️", name: "Warlord", desc: "150 or more total wins", how: "Reach 150 wins all time" },
  { icon: "🛡️", name: "Immortal", desc: "100 or more total wins", how: "Reach 100 wins all time" },
  { icon: "🔮", name: "Mythic", desc: "50 or more total wins", how: "Reach 50 wins all time" },
  { icon: "💎", name: "Elite", desc: "25 or more total wins", how: "Reach 25 wins all time" },
  ...
  { icon: "🎯", name: "25 Kills", desc: "25 total kills across all lobbies", how: "Put 25 eliminations on the board" },
  ...
  { icon: "🎖️", name: "150 Kills", desc: "150 total kills across all lobbies", how: "Reach 150 kills all time" },
  { icon: "☠️", name: "200 Kills", desc: "200 total kills across all lobbies", how: "Reach 200 kills all time" },
  { icon: "☠️", name: "300 Kills", desc: "300 total kills across all lobbies", how: "Reach 300 kills all time" },
  { icon: "💀", name: "500 Kills", desc: "500 total kills. The room knows your name.", how: "Reach 500 all-time kills" },
  { icon: "💀", name: "750 Kills", desc: "750 total kills. Heavy damage history.", how: "Reach 750 all-time kills" },
  { icon: "👹", name: "1K Kills", desc: "1,000 total kills. Permanent damage record.", how: "Reach 1,000 all-time kills" },
  { icon: "👹", name: "1.5K Kills", desc: "1,500 total kills. Damage file keeps climbing.", how: "Reach 1,500 all-time kills" },
  { icon: "👹", name: "2K Kills", desc: "2,000 total kills. Permanent damage tier.", how: "Reach 2,000 all-time kills" },
  { icon: "👹", name: "3K Kills", desc: "3,000 total kills. Archive-level damage.", how: "Reach 3,000 all-time kills" },
  { icon: "👹", name: "5K Kills", desc: "5,000 total kills. The highest damage milestone on file.", how: "Reach 5,000 all-time kills" },
  ...
  { icon: "🕶️", name: "No Kills Bandit", desc: "Won a lobby without landing a kill", how: "Win an official 4+ player lobby with 0 kills" },
  ...
  { icon: "👑", name: "S2 Champion", desc: "Season 2 final wins leader", how: "Finish first by wins in Season 2" },
  { icon: "💀", name: "S2 Reaper", desc: "Season 2 final kill leader", how: "Lead Season 2 in total kills" },
  { icon: "🛡️", name: "S2 Invincible", desc: "Won at least once on every filed Season 2 game day", how: "Season 2 exclusive. Take a crown on every official Season 2 game day before the file closes." },
